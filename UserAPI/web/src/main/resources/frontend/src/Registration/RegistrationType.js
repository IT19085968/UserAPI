...
<div class="table-responsive">
  <table class="table align-middle">
    ...
    <tbody>
      ...
      <td>Paper Presentation up-to one paper Access to all the technical sessions and workshops

Conference kit
Non-transferable and non- refundable</td>
<td><a className="nav-link" href="/ws_presenter">
  ...
  <label class="btn btn-outline-primary" for="btnradio1">Register</label>
      ...
      <td><a className="nav-link" href="/participent">
  ...
  <label class="btn btn-outline-primary" for="btnradio2">Register </label>
      ...
      <th scope="row">Researcher</th>
        ...
        <td><a className="nav-link" href="/researcher">
  <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off"
  ...
  <label class="btn btn-outline-primary" for="btnradio2">Register</label>
    ...
    <td>7,000.00</td>
        <td>All Workshops</td>
        <td><a className="nav-link" href="/workshop">
  <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off"
